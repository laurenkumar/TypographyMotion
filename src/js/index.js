...
let DOM = {
    content: {
        ...
        game: {
            section: document.querySelector('.content__item--game'),
            get picture() {
                return this.section.querySelector('.content__figure');
            },
            isVisible: false
...
(function() {
  ...
  image.src = 'https://static.cnews.fr/sites/default/files/styles/image_640_360/public/000_8vj4gw_5fe9e0754243a.jpg?itok=bAykMr1D';
...
const timeline = gsap.timeline({paused: true})
    ...
    .add( () => {
        ...
        DOM.content.game.section.classList.toggle('content__item--current');
    })
